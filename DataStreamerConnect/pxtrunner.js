...
(function (pxt) {
    ...
    (function (runner) {
        ...
        function renderProjectFilesAsync(content, files, projectid, template, escapeLinks) {
            ...
            var linkString = projectid ? (pxt.appTarget.appTheme.shareUrl || "https://makecode.com/" + projectid) : pxt.appTarget.appTheme.homeUrl;
            if (escapeLinks) {
